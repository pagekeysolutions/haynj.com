...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
	...
	<nav class="navbar navbar-default mynav" role="navigation">
	  ...
	  <div class="navbar-collapse collapse">
	    <ul class="nav navbar-nav navbar-left">
		    ...
		    <li><a href="#" class="active">Wood</a></li>
	    </ul>
    ...
    <div class="row">
	    ...
	    <div class="col-md-8">
	      	<h2>Our Wood</h2>
	     	<p>At HayNJ, we also have a large supply of firewood for sale. For more information about the quantity and type of wood available, contact us.</p>
